# -*- coding: utf-8 -*-
"""
Created on Wed Sep 27 15:07:53 2017

@author: Administrator
"""

'''matplotlib.pyplot.arrow(x,y,dx,dy,hold=None,**kwargs)向坐标轴增加一个箭头，在指定的轴上绘制从(x,y)到(x+dx,y+dy)的箭头'''
#x--浮点型，箭头底部的x坐标; y--浮点型，箭头底部的y坐标;dx--浮点型，沿x坐标的箭头长度;dy--浮点型，沿y坐标的箭头长度;
#**kwargs有：ls--线的样式；lw--线的宽度等等。
